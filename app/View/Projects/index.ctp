    ...
    <tbody>
      <?php foreach ($projects as $project): ?>
        <tr>
          ...
          <td><?php echo $this->Time->nice(h($project['Project']['expected_start_date'])); ?>&nbsp;</td>
          <td><?php echo $this->Time->nice(h($project['Project']['expected_deadline'])); ?>&nbsp;</td>
          <td><?php echo $this->Time->nice(h($project['Project']['start_date'])); ?>&nbsp;</td>
          <td><?php echo $this->Time->nice(h($project['Project']['finish_date'])); ?>&nbsp;</td>
          <td><?php echo h($project['Project']['status']); ?>&nbsp;</td>
          <td><?php echo $this->Time->nice(h($project['Project']['created'])); ?>&nbsp;</td>
          <td><?php echo $this->Time->nice(h($project['Project']['modified'])); ?>&nbsp;</td>
          <td class="actions">
