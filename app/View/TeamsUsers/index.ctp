<div class="teamsUsers index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $teamsUser['TeamsUser']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $teamsUser['TeamsUser']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $teamsUser['TeamsUser']['id']), array(), __('Are you sure you want to delete # %s?', $teamsUser['TeamsUser']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
